"""
Django settings for tool_classifier project.
...
SECRET_KEY = 'django-insecure-5c^smn7sql0pu&(xv@t7)#^gou%@3-+tz3oa2puvj#%8+76+=+'
...
ROOT_URLCONF = 'tool_classifier.urls'
...
WSGI_APPLICATION = 'tool_classifier.wsgi.application'
